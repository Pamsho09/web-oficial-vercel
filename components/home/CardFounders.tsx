...
const cardRef = useRef<any>();
  useScrollTriggerGasp(   "#profileImage" + item.i,
  {
  ...
  return (
    <div
          className=" bg-white w-full shadow md:w-96 p-3 rounded-md relative pt-14 "
        >
          <div className=" z-10  absolute w-full  -top-12  justify-center flex">
            <div className="rounded-full w-28 h-28 overflow-hidden m-auto">
              <img src={item.img} alt="" className="rounded-full w-full h-auto"  id={"profileImage"+item.i} ref={cardRef}/>
            </div>
          </div>
